import { T as EventType_default, c as unlistenByKey, i as getUid, l as Target, o as listen, r as abstract } from "./asserts-DUNxUKpS.js";
import { A as transform, J as containsCoordinate, Q as createEmpty, W as boundingExtent, _t as getTopLeft, at as extendCoordinate, b as getPointResolution, bt as intersects, ct as getArea, dt as getCenter, f as createTransformFromCoordinateTransform, ht as getIntersection, it as extend, lt as getBottomLeft, mt as getHeight, st as forEachCorner, ut as getBottomRight, vt as getTopRight, wt as wrapAndSliceX, x as getTransform, yt as getWidth } from "./proj-BYDU1skc.js";
import { a as modulo, n as clamp, o as solveLinearSystem } from "./math-BYtIDyQ8.js";
import { i as apply } from "./contains-Bl5givOM.js";
import { t as TileState_default } from "./TileState-BV9P4F7q.js";
import { t as easeIn } from "./easing-Ds8nYaIx.js";
import { a as listenImage, d as releaseCanvas, s as createCanvasContext2D, y as WORKER_OFFSCREEN_CANVAS } from "./size-DfTGL_qp.js";
...
var ReprojTile = class extends Tile {
	...
	*/
	constructor(sourceProj, sourceTileGrid, targetProj, targetTileGrid, tileCoord, wrappedTileCoord, pixelRatio, gutter, getTileFunction, errorThreshold, renderEdges, options) {
		...
		*/
		this.triangulation_ = new Triangulation(sourceProj, targetProj, limitedTargetExtent, maxSourceExtent, sourceResolution * (errorThreshold !== void 0 ? errorThreshold : ERROR_THRESHOLD), targetResolution);
...
//#endregion
export { ReprojTile as a, ImageTile as c, withinExtentAndZ as i, Tile as l, getCacheKey as n, TileRange as o, hash as r, createOrUpdate$1 as s, createOrUpdate as t };

//# sourceMappingURL=tilecoord-6smnnFnG.js.map