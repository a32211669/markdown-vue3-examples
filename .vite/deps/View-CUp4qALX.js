import { S as linearFindNearest, n as BaseObject, p as VOID, t as assert } from './asserts-DUNxUKpS.js';
import {
  C as getUserProjection,
  D as toUserCoordinate,
  F as METERS_PER_UNIT,
  I as add,
  O as toUserExtent,
  R as equals,
  St as isEmpty,
  ...
  mt as getHeight,
  p as disableCoordinateWarning,
  pt as getForViewAndSize,
  u as createProjection,
  yt as getWidth,
  z as rotate,
} from './proj-BYDU1skc.js';
import { a as modulo, d as toRadians, n as clamp } from './math-BYtIDyQ8.js';
import { i as fromExtent } from './Polygon-CwOeeBbl.js';
import { n as easeOut, r as inAndOut } from './easing-Ds8nYaIx.js';
  ...
  return function (resolution, direction, size, isMoving) {
    if (resolution !== void 0) {
      ...
      const cappedMaxRes = maxExtent
        ? getViewportClampedResolution(maxResolution, maxExtent, size, showFullExtent)
        : maxResolution;
      if (isMoving) {
  ...
  return function (resolution, direction, size, isMoving) {
    if (resolution !== void 0) {
      ...
      const cappedZoomLevel = Math.floor(
        Math.log(maxResolution / Math.min(cappedMaxRes, resolution)) / Math.log(power) + offset,
      );
      return clamp(
        maxResolution / Math.pow(power, Math.max(minZoomLevel, cappedZoomLevel)),
        minResolution,
        cappedMaxRes,
      );
    }
...
var View = class extends BaseObject {
  ...
  applyOptions_(options) {
     ...
     */
    this.constraints_ = {
      center: createCenterConstraint(options),
      resolution: resolutionConstraintInfo.constraint,
      rotation: createRotationConstraint(options),
    };
    ...
    for (let i = this.animations_.length - 1; i >= 0; --i) {
      ...
      for (let j = 0, jj = series.length; j < jj; ++j) {
        ...
        if (animation.sourceCenter) {
          ...
          this.targetCenter_ = [x0 + progress * (x1 - x0), y0 + progress * (y1 - y0)];
        }
  ...
  calculateCenterZoom(resolution, anchor) {
    ...
    if (currentCenter !== void 0 && currentResolution !== void 0)
      center = [
        anchor[0] - (resolution * (anchor[0] - currentCenter[0])) / currentResolution,
        anchor[1] - (resolution * (anchor[1] - currentCenter[1])) / currentResolution,
      ];
    return center;
  }
  /**
  ...
  applyTargetState_(doNotCancelAnims, forceMoving) {
    ...
    const newCenter = this.constraints_.center(
      ...
      size,
      isMoving,
      this.calculateCenterShift(this.targetCenter_, newResolution, newRotation, size),
    );
    ...
    if (
      ...
      !equals(this.get(ViewProperty_default.CENTER), newCenter)
    )
  ...
  if (options.resolutions !== void 0) {
    ...
    if (minResolution === void 0)
      if (options.maxZoom !== void 0)
        if (options.maxResolution !== void 0) minResolution = maxResolution / Math.pow(zoomFactor, maxZoom);
...
export {
  getView as a,
  withHigherResolutions as c,
  disable as d,
  ViewHint_default as f,
  createRotationConstraint as i,
  withLowerResolutions as l,
  createCenterConstraint as n,
  isNoopAnimation as o,
  createResolutionConstraint as r,
  withExtentCenter as s,
  View as t,
  withZoom as u,
};

//# sourceMappingURL=View-CUp4qALX.js.map
