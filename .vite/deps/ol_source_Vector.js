import { E as ObjectEventType_default, T as EventType_default, _ as binarySearch, b as extend, c as unlistenByKey, f as TRUE, i as getUid, m as memoizeOne, o as listen, p as VOID, t as assert, u as BaseEvent } from "./asserts-DUNxUKpS.js";
import { n as isEmpty } from "./obj-C0zdAnF3.js";
import { $ as createOrUpdate, Q as createEmpty, Y as containsExtent, dt as getCenter, mt as getHeight, nt as createOrUpdateFromFlatCoordinates, rt as equals, tt as createOrUpdateFromCoordinate, wt as wrapAndSliceX, y as get } from "./proj-BYDU1skc.js";
import { i as lerp } from "./math-BYtIDyQ8.js";
import { a as compose, o as create } from "./contains-Bl5givOM.js";
import { a as getInteriorPointsOfMultiArray, c as quantizeArray, f as transform2D, i as getInteriorPointOfArray, o as douglasPeucker, s as douglasPeuckerArray, t as inflateEnds } from "./orient-BQDaEeHr.js";
import { t as RBush$1 } from "./rbush-CcdR7sho.js";
import { n as CollectionEventType_default, t as Collection } from "./Collection-DwxDWj5o.js";
import { t as Source } from "./Source-BH1Tmfee.js";
...
var RenderFeature = class RenderFeature {
	...
	*/
	getExtent() {
		if (!this.extent_) this.extent_ = this.type_ === "Point" ? createOrUpdateFromCoordinate(this.flatCoordinates_) : createOrUpdateFromFlatCoordinates(this.flatCoordinates_, 0, this.flatCoordinates_.length, 2);
		return this.extent_;
	}
	/**
	...
	*/
	getFlatMidpoint() {
		if (!this.flatMidpoints_) this.flatMidpoints_ = interpolatePoint(this.flatCoordinates_, 0, this.flatCoordinates_.length, 2, .5);
	...
	getFlatMidpoints() {
		if (!this.flatMidpoints_) {
			...
			for (let i = 0, ii = ends.length; i < ii; ++i) {
				const end = ends[i];
				const midpoint = interpolatePoint(flatCoordinates, offset, end, 2, .5);
