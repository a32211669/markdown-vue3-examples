import { b as extend, m as memoizeOne, n as BaseObject, r as abstract } from "./asserts-DUNxUKpS.js";
import { Ct as returnOrUpdate, Q as createEmpty, St as isEmpty, U as offset, X as containsXY, dt as getCenter, et as createOrUpdateEmpty, mt as getHeight, nt as createOrUpdateFromFlatCoordinates, q as closestSquaredDistanceXY, tt as createOrUpdateFromCoordinate, x as getTransform, y as get } from "./proj-BYDU1skc.js";
import { a as modulo, i as lerp, s as squaredDistance } from "./math-BYtIDyQ8.js";
import { a as compose, o as create, r as linearRingsContainsXY } from "./contains-Bl5givOM.js";
import { c as quantizeArray, d as scale, f as transform2D, i as getInteriorPointOfArray, n as linearRingsAreOriented, o as douglasPeucker, p as translate, r as orientLinearRings, u as rotate } from "./orient-BQDaEeHr.js";
import { n as intersectsLinearRingArray } from "./intersectsextent-CRZ81NCr.js";
...
function circular(center, radius, n, sphereRadius) {
	...
	for (let i = 0; i < n; ++i) extend(flatCoordinates, offset(center, radius, 2 * Math.PI * i / n, sphereRadius));
...
//#endregion
export { makeRegular as a, inflateMultiCoordinatesArray as c, fromExtent as i, transformGeom2D as l, circular as n, inflateCoordinates as o, fromCircle as r, inflateCoordinatesArray as s, Polygon as t };

//# sourceMappingURL=Polygon-CwOeeBbl.js.map