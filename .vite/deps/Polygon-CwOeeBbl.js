...
import {
  ...
  mt as getHeight,
  nt as createOrUpdateFromFlatCoordinates,
  q as closestSquaredDistanceXY,
  tt as createOrUpdateFromCoordinate,
  x as getTransform,
  y as get,
...
import {
  ...
  d as scale,
  f as transform2D,
  i as getInteriorPointOfArray,
  n as linearRingsAreOriented,
  o as douglasPeucker,
  p as translate,
  r as orientLinearRings,
  u as rotate,
} from './orient-BQDaEeHr.js';
...
function assignClosestPoint(
  ...
  while (index < end) {
    ...
    if (squaredDistance$2 < minSquaredDistance) {
      ...
      index += stride * Math.max(((Math.sqrt(squaredDistance$2) - Math.sqrt(minSquaredDistance)) / maxDelta) | 0, 1);
  }
  if (isRing) {
  ...
  for (let j = 0, jj = endss.length; j < jj; ++j) {
    ...
    coordinatesss[i++] =
      ends.length === 1 && ends[0] === offset
        ? []
        : inflateCoordinatesArray(flatCoordinates, offset, ends, stride, coordinatesss[i]);
...
var Polygon = class Polygon extends SimpleGeometry {
  ...
  getLinearRing(index) {
    ...
    return new LinearRing(
      this.flatCoordinates.slice(index === 0 ? 0 : this.ends_[index - 1], this.ends_[index]),
      this.layout,
    );
  }
  /**
...
export {
  makeRegular as a,
  inflateMultiCoordinatesArray as c,
  fromExtent as i,
  transformGeom2D as l,
  circular as n,
  inflateCoordinates as o,
  fromCircle as r,
  inflateCoordinatesArray as s,
  Polygon as t,
};
