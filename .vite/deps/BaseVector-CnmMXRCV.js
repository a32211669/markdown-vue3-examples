...
import { r as toSize } from "./size-DfTGL_qp.js";
import { a as lchaToRgba, c as withAlpha, i as fromString, o as rgbaToLcha, s as toString, t as NO_COLOR } from "./color-CoT09zS8.js";
import { t as Layer } from "./Layer-CkA48-Ee.js";
import { a as Stroke, c as CircleStyle, i as toFunction, l as RegularShape, n as Style, o as Icon, r as createDefaultStyle, s as Fill, t as Text } from "./Text-Dob7Y1Fx.js";
import { t as RBush } from "./rbush-CcdR7sho.js";
...
function buildText(flatStyle, context) {
	...
	const text = new Text({ declutterMode: optionalDeclutterMode(flatStyle, prefix + "declutter-mode") });
	return function(context) {
...
function buildIcon(flatStyle, context) {
	...
	if (colorValue !== void 0) if (Array.isArray(colorValue) && colorValue.length > 0 && typeof colorValue[0] === "string") evaluateColor = colorLikeEvaluator(flatStyle, prefix + "color", context);
	else color = requireColorLike(colorValue, prefix + "color");
	...
	const iconOptions = {
		...
		offset,
		offsetOrigin,
		height: optionalNumber(flatStyle, prefix + "height"),
		width,
		size: optionalSize(flatStyle, prefix + "size"),
		declutterMode: optionalDeclutterMode(flatStyle, prefix + "declutter-mode")
	};
	let icon = null;
	return function(context) {
		if (!icon) {
...
function buildShape(flatStyle, context) {
	...
	const shape = new RegularShape({
		...
		angle: optionalNumber(flatStyle, prefix + "angle"),
		declutterMode: optionalDeclutterMode(flatStyle, prefix + "declutter-mode")
	});
	return function(context) {
...
//#endregion
export { BaseVectorLayer as t };

//# sourceMappingURL=BaseVector-CnmMXRCV.js.map