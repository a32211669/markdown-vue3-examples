import { E as ObjectEventType_default, T as EventType_default$1, c as unlistenByKey, d as FALSE, f as TRUE, h as toPromise, i as getUid, l as Target, n as BaseObject, o as listen, p as VOID, r as abstract, t as assert, u as BaseEvent, w as Disposable, y as equals } from "./asserts-DUNxUKpS.js";
import { t as clear } from "./obj-C0zdAnF3.js";
import { B as scale, D as toUserCoordinate, H as warn, K as clone, St as isEmpty, V as wrapX, et as createOrUpdateEmpty, g as fromUserCoordinate, ht as getIntersection, pt as getForViewAndSize, rt as equals$1, yt as getWidth, z as rotate } from "./proj-BYDU1skc.js";
...
import { _ as PASSIVE_EVENT_LISTENERS, c as createMockDiv, f as removeChildren, g as MAC, h as DEVICE_PIXEL_RATIO, m as replaceNode, p as replaceChildren, t as hasArea, u as isCanvas, v as WEBKIT, y as WORKER_OFFSCREEN_CANVAS } from "./size-DfTGL_qp.js";
import { a as RenderEvent, i as EventType_default$2, n as inView, r as BaseLayer, t as Layer } from "./Layer-CkA48-Ee.js";
import { d as disable, f as ViewHint_default, t as View } from "./View-CUp4qALX.js";
import { D as CLASS_HIDDEN, E as CLASS_CONTROL, O as CLASS_UNSELECTABLE, T as CLASS_COLLAPSED, d as checkedFonts, j as shared } from "./Text-Dob7Y1Fx.js";
	...
	*/
	handleEvent(mapBrowserEvent) {
		...
		if (this.handlingDownUpSequence) {
			...
			} else if (mapBrowserEvent.type == MapBrowserEventType_default.POINTERUP) this.handlingDownUpSequence = this.handleUpEvent(mapBrowserEvent) && this.targetPointers.length > 0;
...
var MouseWheelZoom = class extends Interaction {
	...
	*/
	endInteraction_() {
		...
		if (!map) return;
		map.getView().endInteraction(void 0, this.lastDelta_ ? this.lastDelta_ > 0 ? 1 : -1 : 0, this.lastAnchor_ ? map.getCoordinateFromPixel(this.lastAnchor_) : null);
	}
	/**
