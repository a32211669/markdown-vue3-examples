import { T as EventType_default, a as Observable, r as abstract, y as equals } from "./asserts-DUNxUKpS.js";
import { _t as getTopLeft, lt as getBottomLeft, mt as getHeight, ut as getBottomRight, vt as getTopRight, yt as getWidth } from "./proj-BYDU1skc.js";
import { a as compose, d as toString, i as apply, l as makeInverse, o as create, s as equivalent } from "./contains-Bl5givOM.js";
import { c as createMockDiv, l as getSharedCanvasContext2D, o as ImageState_default, s as createCanvasContext2D, u as isCanvas, y as WORKER_OFFSCREEN_CANVAS } from "./size-DfTGL_qp.js";
import { n as asArray } from "./color-CoT09zS8.js";
import { a as RenderEvent, i as EventType_default$1 } from "./Layer-CkA48-Ee.js";
	...
	constructor() {
		...
		*/
		this.context_ = new Proxy(getSharedCanvasContext2D(), {
			get: (target, property) => {
				if (typeof getSharedCanvasContext2D()[property] !== "function") return;
				this.push_(property);
...
var LayerRenderer = class extends Observable {
	...
	*/
	loadImage(image) {
		...
		if (imageState != ImageState_default.LOADED && imageState != ImageState_default.ERROR) image.addEventListener(EventType_default.CHANGE, this.boundHandleImageChange_);
...
//#endregion
//#region node_modules/ol/renderer/canvas/Layer.js
/**
 ...
 /** @type {HTMLCanvasElement} */ canvas.style.transform = canvasTransform;
	...
	*/
	preRender(context, frameState) {
		...
		this.dispatchRenderEvent_(EventType_default$1.PRERENDER, context, frameState);
	}
	/**
	* @param {CanvasRenderingContext2D|OffscreenCanvasRenderingContext2D} context Context.
	* @param {import("../../Map.js").FrameState} frameState Frame state.
	...
	*/
	postRender(context, frameState) {
		if (frameState.declutter) return;
		this.dispatchRenderEvent_(EventType_default$1.POSTRENDER, context, frameState);
	}
	/**
	* @param {import("../../Map.js").FrameState} frameState Frame state.
	*/
	...
	*/
	renderDeferred(frameState) {
		if (!frameState.declutter) return;
		this.dispatchRenderEvent_(EventType_default$1.PRERENDER, this.context, frameState);
		if (frameState.declutter && this.deferredContext_) {
			this.deferredContext_.draw(this.context);
			this.deferredContext_.clear();
		}
		this.renderDeferredInternal(frameState);
		this.dispatchRenderEvent_(EventType_default$1.POSTRENDER, this.context, frameState);
	}
	/**
...
//#endregion
export { canvasPool as n, ZIndexContext as r, CanvasLayerRenderer as t };

//# sourceMappingURL=Layer-CotuPRNK.js.map