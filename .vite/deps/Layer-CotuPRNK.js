  ...
  draw(context) {
    this.instructions_.forEach((instructionsAtIndex) => {
      for (let i = 0, ii = instructionsAtIndex.length; i < ii; ++i) {
        ...
        if (typeof context[property] === 'function') /** @type {*} */ context[property](...instructionAtIndex);
        else {
    ...
    if (
      ...
      (!backgroundColor ||
        (target &&
          ...
          equals(asArray(target.style.backgroundColor), asArray(backgroundColor))))
    ) {
