...
function applyTransform(extent, transformFn, dest, stops) {
  ...
  } else coordinates = [extent[0], extent[1], extent[2], extent[1], extent[2], extent[3], extent[0], extent[3]];
...
function angleBetween(p0, pA, pB) {
  ...
  let angle =
    lenA === 0 || lenB === 0 ? 0 : Math.acos(clamp(tangentB[0] * tangentA[0] + tangentB[1] * tangentA[1], -1, 1));
...
function fromLonLat$1(longitude, latitude, zone) {
  ...
  const easting =
    K0 * n * (a + (a3 / 6) * (1 - latTan2 + c) + (a5 / 120) * (5 - 18 * latTan2 + latTan4 + 72 * c - 58 * E_P2)) + 5e5;
  let northing =
    K0 *
    (m +
      n *
  ...
  if (getter) {
    ...
    if ((projUnits == 'degrees' && !units) || units == 'degrees') pointResolution = resolution;
      ...
      if (!toEPSG4326 && projUnits !== 'degrees') pointResolution = resolution * projection.getMetersPerUnit();
        ...
        pointResolution =
          (getDistance(vertices.slice(0, 2), vertices.slice(2, 4)) +
            getDistance(vertices.slice(4, 6), vertices.slice(6, 8))) /
          2;
      }
...
export {
  ...
  transform as A,
  scale as B,
  getUserProjection as C,
  returnOrUpdate as Ct,
  toUserCoordinate as D,
  toLonLat as E,
  Relationship_default as Et,
  METERS_PER_UNIT$1 as F,
  buffer as G,
  warn as H,
  add$2 as I,
  containsCoordinate as J,
  clone as K,
  angleBetween as L,
  transformWithProjections as M,
  useGeographic as N,
  toUserExtent as O,
  Projection as P,
  createEmpty as Q,
  equals as R,
  getTransformFromProjections as S,
  isEmpty as St,
  setUserProjection as T,
  wrapX$1 as Tt,
  offset as U,
  wrapX as V,
  boundingExtent as W,
  containsXY as X,
  containsExtent as Y,
  coordinateRelationship as Z,
  fromUserExtent as _,
  getTopLeft as _t,
  addProjection as a,
  extendCoordinate as at,
  getPointResolution as b,
  intersects as bt,
  clearUserProjection as c,
  getArea as ct,
  createSafeCoordinateTransform as d,
  getCenter as dt,
  createOrUpdateEmpty as et,
  createTransformFromCoordinateTransform as f,
  getCorner as ft,
  fromUserCoordinate as g,
  getRotatedViewport as gt,
  fromLonLat as h,
  getIntersection as ht,
  addEquivalentTransforms as i,
  extend as it,
  transformExtent as j,
  toUserResolution as k,
  cloneTransform as l,
  getBottomLeft as lt,
  equivalent as m,
  getHeight as mt,
  addCoordinateTransforms as n,
  createOrUpdateFromFlatCoordinates as nt,
  addProjections as o,
  extendFlatCoordinates as ot,
  disableCoordinateWarning as p,
  getForViewAndSize as pt,
  closestSquaredDistanceXY as q,
  addEquivalentProjections as r,
  equals$1 as rt,
  clearAllProjections as s,
  forEachCorner as st,
  addCommon as t,
  createOrUpdateFromCoordinate as tt,
  createProjection as u,
  getBottomRight as ut,
  fromUserResolution as v,
  getTopRight as vt,
  identityTransform as w,
  wrapAndSliceX as wt,
  getTransform as x,
  intersectsSegment as xt,
  get as y,
  getWidth as yt,
  rotate as z,
};
