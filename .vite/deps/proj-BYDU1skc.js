import { a as modulo, d as toRadians, f as wrap, l as toDegrees, n as clamp } from "./math-BYtIDyQ8.js";
...
function _boundingExtentXYs(xs, ys, dest) {
	return createOrUpdate(Math.min.apply(null, xs), Math.min.apply(null, ys), Math.max.apply(null, xs), Math.max.apply(null, ys), dest);
}
/**
...
function offset(c1, distance, bearing, radius) {
	...
	return [toDegrees(lon1 + Math.atan2(Math.sin(bearing) * Math.sin(dByR) * Math.cos(lat1), Math.cos(dByR) - Math.sin(lat1) * Math.sin(lat))), toDegrees(lat)];
}
//#endregion
...
addCommon();
//#endregion
export { createOrUpdate as $, transform as A, scale as B, getUserProjection as C, returnOrUpdate as Ct, toUserCoordinate as D, toLonLat as E, Relationship_default as Et, METERS_PER_UNIT$1 as F, buffer as G, warn as H, add$2 as I, containsCoordinate as J, clone as K, angleBetween as L, transformWithProjections as M, useGeographic as N, toUserExtent as O, Projection as P, createEmpty as Q, equals as R, getTransformFromProjections as S, isEmpty as St, setUserProjection as T, wrapX$1 as Tt, offset as U, wrapX as V, boundingExtent as W, containsXY as X, containsExtent as Y, coordinateRelationship as Z, fromUserExtent as _, getTopLeft as _t, addProjection as a, extendCoordinate as at, getPointResolution as b, intersects as bt, clearUserProjection as c, getArea as ct, createSafeCoordinateTransform as d, getCenter as dt, createOrUpdateEmpty as et, createTransformFromCoordinateTransform as f, getCorner as ft, fromUserCoordinate as g, getRotatedViewport as gt, fromLonLat as h, getIntersection as ht, addEquivalentTransforms as i, extend as it, transformExtent as j, toUserResolution as k, cloneTransform as l, getBottomLeft as lt, equivalent as m, getHeight as mt, addCoordinateTransforms as n, createOrUpdateFromFlatCoordinates as nt, addProjections as o, extendFlatCoordinates as ot, disableCoordinateWarning as p, getForViewAndSize as pt, closestSquaredDistanceXY as q, addEquivalentProjections as r, equals$1 as rt, clearAllProjections as s, forEachCorner as st, addCommon as t, createOrUpdateFromCoordinate as tt, createProjection as u, getBottomRight as ut, fromUserResolution as v, getTopRight as vt, identityTransform as w, wrapAndSliceX as wt, getTransform as x, intersectsSegment as xt, get as y, getWidth as yt, rotate as z };

//# sourceMappingURL=proj-BYDU1skc.js.map