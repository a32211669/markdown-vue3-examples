import { T as EventType_default$1, c as unlistenByKey, n as BaseObject, o as listen, r as abstract, t as assert, u as BaseEvent } from "./asserts-DUNxUKpS.js";
import { bt as intersects } from "./proj-BYDU1skc.js";
import { n as clamp } from "./math-BYtIDyQ8.js";
import { t as View } from "./View-CUp4qALX.js";
...
//#endregion
//#region node_modules/ol/render/EventType.js
/**
...
//#endregion
//#region node_modules/ol/layer/Base.js
/**
...
//#endregion
//#region node_modules/ol/layer/Layer.js
/**
...
var Layer = class extends BaseLayer {
	...
	*/
	handleSourcePropertyChange_() {
		...
		const source = this.getSource();
		if (source) {
			this.sourceChangeKey_ = listen(source, EventType_default$1.CHANGE, this.handleSourceChange_, this);
	...
	*/
	setMap(map) {
		...
		if (map) {
			...
			this.mapRenderKey_ = listen(this, EventType_default$1.CHANGE, map.render, map);
			this.changed();
		}
	}
	/**
...
//#endregion
export { RenderEvent as a, EventType_default as i, inView as n, BaseLayer as r, Layer as t };

//# sourceMappingURL=Layer-CkA48-Ee.js.map