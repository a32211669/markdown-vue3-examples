import { g as ascending, i as getUid, t as assert, w as Disposable } from "./asserts-DUNxUKpS.js";
import { J as containsCoordinate, Q as createEmpty, _ as fromUserExtent, _t as getTopLeft, bt as intersects, gt as getRotatedViewport, ht as getIntersection, m as equivalent, rt as equals } from "./proj-BYDU1skc.js";
import { a as compose, i as apply } from "./contains-Bl5givOM.js";
import { t as TileState_default } from "./TileState-BV9P4F7q.js";
import { a as ReprojTile, c as ImageTile, l as Tile, n as getCacheKey, o as TileRange, t as createOrUpdate } from "./tilecoord-6smnnFnG.js";
import { r as toSize } from "./size-DfTGL_qp.js";
import { t as Layer } from "./Layer-CkA48-Ee.js";
import { t as CanvasLayerRenderer } from "./Layer-CotuPRNK.js";
	...
	*/
	getOrCreateTile(z, x, y, frameState) {
		...
		if (tileCache.containsKey(cacheKey)) tile = tileCache.get(cacheKey);
			...
			tile = tileSource.getTile(z, x, y, frameState.pixelRatio, projection, !sourceProjection || equivalent(sourceProjection, projection) ? void 0 : this.getSourceTileCache());
			if (!tile) return null;
	...
	*/
	renderFrame(frameState, target) {
		...
		*/
		...
		if (layerExtent) frameExtent = getIntersection(frameExtent, fromUserExtent(layerState.extent, projection));
...
//#endregion
//#region node_modules/ol/layer/BaseTile.js
/**
