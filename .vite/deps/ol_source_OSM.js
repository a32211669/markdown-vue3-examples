import { S as linearFindNearest, T as EventType_default, i as getUid, r as abstract, t as assert, u as BaseEvent, x as isSorted } from "./asserts-DUNxUKpS.js";
import { $ as createOrUpdate, F as METERS_PER_UNIT, J as containsCoordinate, _t as getTopLeft, ft as getCorner, m as equivalent, mt as getHeight, y as get, yt as getWidth } from "./proj-BYDU1skc.js";
import { a as modulo, n as clamp, r as floor, t as ceil } from "./math-BYtIDyQ8.js";
import { t as intersectsLinearRing } from "./intersectsextent-CRZ81NCr.js";
import { t as TileState_default } from "./TileState-BV9P4F7q.js";
import { a as ReprojTile, c as ImageTile, i as withinExtentAndZ, n as getCacheKey, o as TileRange, r as hash, s as createOrUpdate$1, t as createOrUpdate$2 } from "./tilecoord-6smnnFnG.js";
import { n as scale, r as toSize, y as WORKER_OFFSCREEN_CANVAS } from "./size-DfTGL_qp.js";
...
var TileGrid = class {
	...
	*/
	getTileCoordExtent(tileCoord, tempExtent) {
		...
		return createOrUpdate(minX, minY, minX + tileSize[0] * resolution, minY + tileSize[1] * resolution, tempExtent);
	}
	/**
...
//#endregion
//#region node_modules/ol/source/TileImage.js
/**
...
var TileImage = class extends UrlTile {
	...
	*/
	getGutterForProjection(projection) {
		if (this.getProjection() && projection && !equivalent(this.getProjection(), projection)) return 0;
	...
	*/
	getTileGridForProjection(projection) {
		...
		if (this.tileGrid && (!thisProj || equivalent(thisProj, projection))) return this.tileGrid;
	...
	*/
	getTile(z, x, y, pixelRatio, projection, tileCache) {
		...
		if (!sourceProjection || !projection || equivalent(sourceProjection, projection)) return this.getTileInternal(z, x, y, pixelRatio, sourceProjection || projection);
		const tileCoord = [
			z,
			x,
			y
