...
import {
  a as ReprojTile,
  c as ImageTile,
  i as withinExtentAndZ,
  n as getCacheKey,
  o as TileRange,
  r as hash,
  s as createOrUpdate$1,
  t as createOrUpdate$2,
} from './tilecoord-6smnnFnG.js';
...
var TileGrid = class {
  ...
  forEachTileCoord(extent, zoom, callback) {
    ...
    for (let i = tileRange.minX, ii = tileRange.maxX; i <= ii; ++i)
      for (let j = tileRange.minY, jj = tileRange.maxY; j <= jj; ++j) callback([zoom, i, j]);
  }
  /**
  ...
  getTileRangeForTileCoordAndZ(tileCoord, z, tempTileRange) {
    ...
    if (this.zoomFactor_) {
      ...
      return createOrUpdate$1(
        minX,
        Math.floor(factor * (tileCoordX + 1)) - 1,
        minY,
        Math.floor(factor * (tileCoordY + 1)) - 1,
        tempTileRange,
      );
    }
...
var UrlTile = class UrlTile extends TileSource {
  ...
  handleTileChange(event) {
    ...
    if (tileState == TileState_default.LOADING) {
      ...
      type =
        tileState == TileState_default.ERROR
          ? TileEventType_default.TILELOADERROR
          : tileState == TileState_default.LOADED
          ? TileEventType_default.TILELOADEND
          : void 0;
    }
...
var TileImage = class extends UrlTile {
  ...
  getTile(z, x, y, pixelRatio, projection, tileCache) {
    ...
    const tile = new ReprojTile(
      sourceProjection,
      this.getTileGridForProjection(sourceProjection),
      projection,
      ...
      this.getGutter(),
      (z, x, y, pixelRatio) => this.getTileInternal(z, x, y, pixelRatio, sourceProjection, tileCache),
