...
var Observable = class extends Target {
  ...
  unInternal(type, listener) {
    ...
    if (key) unByKey(key);
      ...
      for (let i = 0, ii = type.length; i < ii; ++i) this.removeEventListener(type[i], listener);
...
//#endregion
export {
  reverseSubArray as C,
  ObjectEventType_default as E,
  linearFindNearest as S,
  EventType_default as T,
  binarySearch as _,
  Observable as a,
  extend as b,
  unlistenByKey as c,
