...
ua.includes('safari') &&
  !ua.includes('chrom') &&
  (ua.includes('version/15.4') || /cpu (os|iphone os) 15_4 like mac os x/.test(ua));
/**
  ...
  return image.src && IMAGE_DECODE
    ? new Promise((resolve, reject) =>
        image
          .decode()
          .then(() => resolve(image))
          .catch((e) => (image.complete && image.width ? resolve(image) : reject(e))),
      )
    : load(image);
}
//#endregion
...
//#endregion
export {
  PASSIVE_EVENT_LISTENERS as _,
  listenImage as a,
  createMockDiv as c,
  releaseCanvas as d,
  removeChildren as f,
  MAC as g,
  DEVICE_PIXEL_RATIO as h,
  decodeFallback as i,
  getSharedCanvasContext2D as l,
  replaceNode as m,
  scale as n,
  ImageState_default as o,
  replaceChildren as p,
  toSize as r,
  createCanvasContext2D as s,
  hasArea as t,
  isCanvas as u,
  WEBKIT as v,
  WORKER_OFFSCREEN_CANVAS as y,
};
