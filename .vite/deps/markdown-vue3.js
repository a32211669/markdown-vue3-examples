import {
  ...
  Yt as resolveComponent,
  Z as createSlots,
  Zt as resolveDynamicComponent,
  dn as useSlots,
  et as createVNode,
  ft as guardReactiveProps,
  gn as watch,
  gr as normalizeProps,
  hr as normalizeClass,
  nr as unref,
  nt as defineComponent,
  q as createElementBlock,
  qt as renderList,
  vr as toDisplayString,
  xn as withCtx,
  xt as inject,
...
function N(e, t) {
  let n = A(e),
    r = Object.keys(n).length ? JSON.stringify(n, Object.keys(n).sort()) : '',
    i = e.templateType;
  if (i) {
  ...
  (e.type === 'text' || e.type === 'code_inline' || e.type === 'html_inline' || e.type === 'html_block') &&
    (a = a.slice(0, 50));
  let o = M(e, t);
...
function te(e) {
  ...
  if ((n && (e.tag = n[2]), t === 1 || t === 0)) {
    let t = e.content.indexOf(e.tag) + e.tag.length,
      n = e.content.length - 1;
...
function F(e) {
  let { tokens: t, tags: n, fences: r, onThinking: i, onProgress: a } = e,
    o = [],
    s = [],
    c = (e) => {
      if (!('templateType' in e) || !e.templateType)
        if (e.type === 'fence') {
    ...
    if (r.nesting === 1)
      if (r.tag) {
        ...
        if (r.type.startsWith('container_')) {
          ...
          r.type === 'html_inline'
            ? (t.templateType = 'group:html_inline')
            : n.includes(r.tag) && (t.templateType = `tag:${r.tag}`);
        o.push(t);
      } else c(r);
    else if (r.nesting === -1) {
      let e = o.pop();
      e &&
        ((e.close = r),
        e._skip
          ? e.templateType === 'container:thinking' && i
            ? i(e)
            : e.templateType === 'container:progress' && a && a(e)
          : c(e));
...
function I(e, t, n) {
  ...
  function u(e, n, r, i) {
    ...
    if (p < 3) return !1;
    l -= (l - d) % s;
    let m = e.src.slice(d, l),
      h = e.src.slice(l, f);
    if (!c(h, m)) return !1;
    if (i) return !0;
    let g = n;
    for (; g++, !(g >= r || ((d = e.bMarks[g] + e.tShift[g]), (f = e.eMarks[g]), d < f && e.sCount[g] < e.blkIndent)); )
      if (o === e.src.charCodeAt(d) && !(e.sCount[g] - e.blkIndent >= 4)) {
        for (l = d + 1; l <= f && a[(l - d) % s] === e.src[l]; l++);
  ...
  e.block.ruler.before('fence', 'container_' + t, u, { alt: ['paragraph', 'reference', 'blockquote', 'list'] }),
...
var L = { key: 2 },
              ...
              renderSlot(
                ...
                () => [
                  f(t)
                    ...
                    : t.type === 'text'
                    ? (openBlock(),
                      createElementBlock(Fragment, { key: 1 }, [createTextVNode(toDisplayString(t.content), 1)], 64))
                    : t.type === 'hr'
                    ? (openBlock(), createElementBlock('hr', L))
                    : t.type === 'fence' || t.type === 'code_block'
                    ? (openBlock(),
                      createElementBlock('pre', R, [
                        createBaseVNode(
                          'code',
                          { class: normalizeClass(`language-${t.info?.split(' ')[0] || ''}`) },
                          toDisplayString(t.content),
                          3,
                        ),
                      ]))
                    : t.type === 'code_inline'
                    ? (openBlock(), createElementBlock('code', z, toDisplayString(t.content), 1))
                    : t.type === 'image'
                    ? (openBlock(),
                      createElementBlock(
                        'img',
                    ...
                    : t.type === 'hardbreak'
                    ? (openBlock(), createElementBlock('br', V))
                    : t.type === 'softbreak'
                    ? (openBlock(),
                      createElementBlock(
                        Fragment,
                        ...
                        [
                          unref(l)
                            ? (openBlock(), createElementBlock('br', H))
                            : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createTextVNode(' \xA0 ')], 64)),
                        ],
                        64,
                      ))
                    : t.type === 'html_block'
  ...
  J = /* @__PURE__ */ defineComponent({
    ...
    setup(e) {
      ...
      return (
        ...
        (e, t) => (
          openBlock(),
          createElementBlock('div', q, [
            (t[1] ||= createBaseVNode(
              'header',
              null,
              [createBaseVNode('div', { class: 'icon' }), createBaseVNode('div', { class: 'title' }, '已深度思考')],
              -1,
            )),
            createBaseVNode('main', null, [
              (t[0] ||= createBaseVNode('div', { class: 'main-icon' }, null, -1)),
              createVNode(K, { tree: n.value }, null, 8, ['tree']),
            ]),
          ])
        )
      );
  ...
  Y =
    'data:image/webp;base64,',
  X =
    'data:image/webp;base64,',
  Z =
    'data:image/webp;base64,',
  ne = {
    key: 0,
    class: 'tasks-list',
  },
  re = ['src'],
  ie = { class: 'task-content' },
                  ...
                  (e, t) => (
                    ...
                    createElementBlock(
                      ...
                      [
                        ...
                        createBaseVNode('div', ie, toDisplayString(e.content), 1),
                      ],
                    )
                  ),
                ),
  ...
  $ = /* @__PURE__ */ defineComponent({
    ...
    setup(n) {
      let a = n,
        s = useSlots(),
        { md: l, containers: d, sanitize: p } = a;
      provide('md', markRaw(l)),
        provide('sanitizeHtml', (e) => (typeof p == 'function' ? p(e) : e)),
        Array.isArray(d) &&
          d.length &&
          [...new Set(d.concat(['progress', 'thinking']))].forEach((e) => {
            l.use(I, e);
          });
      let m = ref(),
        x = ref(),
          ...
          [
            x.value
              ? renderSlot(
                  ...
                  () => [createVNode(Q, { node: x.value }, null, 8, ['node'])],
                )
              : createCommentVNode('', !0),
            m.value
              ? renderSlot(
                  ...
                  () => [createVNode(J, { node: m.value }, null, 8, ['node'])],
                )
              : createCommentVNode('', !0),
            createVNode(
              K,
